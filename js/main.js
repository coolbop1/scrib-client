const hoverserch = () =>{
	document.getElementById("schbut").classList.replace("serchin","serchout");
document.getElementById("mainsearch").classList.replace(".buttonebook",".buttonebooks");

document.getElementById("searchinput").classList.replace("serchout","serchin");
}
const opennav = (tok) => {
...
const navigate = (page) => {
	let contentstate = document.getElementById("contents");
	if(contentstate.classList.contains(page)){
		console.log(page);
		return;
	}else{
	fetch("/"+page+".html")
